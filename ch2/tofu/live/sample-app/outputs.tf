...
output "sample_app_3_public_ip" {
  description = "The public IP of the sample-app-3 instance"
  value       = module.sample_app_3.public_ip
}
...
output "sample_app_3_instance_id" {
  description = "The ID of the sample-app-3 instance"
  value       = module.sample_app_3.instance_id
}